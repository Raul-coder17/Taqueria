...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO usuarios (nombre, email, password, rol) VALUES (?, ?, ?, 'mesero')");
        $stmt->execute([$nombre, $email, $password]);
        $success = "Mesero registrado con éxito.";
...
<head>
    <meta charset="UTF-8">
    <title>Registrar Mesero - Taquería</title>
...
<body>
    <div class="container">
        ...
        <form method="POST">
            ...
            <input type="text" id="nombre" name="nombre" placeholder="Ej. Mesero Pedro" required>
